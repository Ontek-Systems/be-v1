...
export function DestinationHero({
  ...
  return (
    <section className="relative flex h-dvh min-h-160 items-center justify-center overflow-hidden">
      ...
      <span
        aria-hidden="true"
        className="pointer-events-none absolute inset-x-0 top-1/2 -translate-y-1/2 select-none text-center text-[26vw] font-display font-bold leading-none text-white/10"
      >
        {watermark}
      </span>
