      ...
      <Container>
        <div className="grid grid-cols-1 gap-12 sm:grid-cols-3 sm:gap-10">
          {highlights.map((highlight, index) => (
            ...
            >
              <p className="text-5xl font-display font-bold leading-none text-primary-navy sm:text-6xl lg:text-7xl">
                {highlight.value}
              </p>
              <p className="mx-auto mt-4 max-w-[16rem] text-sm leading-relaxed text-primary-sky">
                {highlight.label}
              </p>
            </motion.div>
          ))}
