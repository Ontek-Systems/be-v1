...
export function ButtonSweep() {
  return (
    <>
      ...
      <span
        aria-hidden="true"
        className="absolute inset-y-0 left-0 w-1 bg-primary-sky opacity-0 transition-opacity duration-300 ease-in-out group-hover:opacity-100 motion-reduce:transition-none"
      />
    </>
  );
}
